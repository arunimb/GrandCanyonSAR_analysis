...
delim = ","
dec = "."
testResults = read.csv("E:/GrandCanyonSAR_analysis/src/stats/outputTables/outputForFracCompleteStops.csv", header=TRUE, sep=delim, dec=dec, stringsAsFactors=FALSE)
