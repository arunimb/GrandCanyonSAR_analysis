...
delim = ","
dec = "."
testResults = read.csv("E:/GrandCanyonSAR_analysis/src/stats/outputTables/outputForFracPartialStops.csv", header=TRUE, sep=delim, dec=dec, stringsAsFactors=FALSE)
...
mod0 = glm(fracPartialStops ~ 1 + SwarmCohesion + TargetKnowledge + TerrainKnowledge , family = gaussian(link="identity"), data = testResults)
summary(mod0)
