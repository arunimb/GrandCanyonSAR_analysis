...
for ii = 1:numel(subject)
    ...
    for j = 1:numel(trialNum)
        ...
        saveFolder = [preFolder, cell2mat(subject(ii)),'\',num2str(trialNum(j)),'\','freeze','.csv'];
        writematrix("Fraction complete stops and partial stops",saveFolder);
        writematrix([fracCompleteStops,fracPartialStops]',saveFolder,'WriteMode','append');
    end
end