...
#mod2 = glm(MentalTLX ~ 1 + SwarmCohesion + TargetKnowledge , family = gaussian(link="identity"), data = testResults)
#mod3 = glm(MentalTLX ~ 1 + SwarmCohesion + TargetKnowledge + TerrainKnowledge , family = gaussian(link="identity"), data = testResults)
#mod4 = glm(MentalTLX ~ 1 + SwarmCohesion + TargetKnowledge + TerrainKnowledge + SwarmCohesion * TargetKnowledge , family = gaussian(link="identity"), data = testResults)
