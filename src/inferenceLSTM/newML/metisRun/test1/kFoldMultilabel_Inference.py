        ...
        while j < K2:
            ...
            while k < len(parameterSpace):
                ...
                with open("progress.txt", "a+") as file:
                    file.write(' Window Size = {}, Outer Loop no. = {}, Inner Loop no. = {}, Parameter Space no. = {}, Accuracy = {}, MaxAccuracy = {} \n'.format(win,i,j,k, innerHistory.history['val_accuracy'][-1], np.max(innerHistory.history['val_accuracy'])))
            j = j + 1
            k = 0
            with open(writeToFolder+'j.pkl', 'wb') as file:
                pickle.dump(j, file)
